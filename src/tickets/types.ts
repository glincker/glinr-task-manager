...
export const TicketType = z.enum(['task', 'bug', 'feature', 'epic', 'story', 'subtask']);
export type TicketType = z.infer<typeof TicketType>;

export const TicketPriority = z.enum(['critical', 'high', 'medium', 'low', 'none']);
...
export const TicketQuerySchema = z.object({
  ...
  sortBy: z.enum(['createdAt', 'updatedAt', 'priority', 'sequence', 'dueDate']).optional(),
...
export const REVERSE_STATUS_MAP: Record<string, Record<string, TicketStatus>> = {
  jira: {
    'To Do': 'todo',
...
export const PRIORITY_MAP: Record<TicketPriority, Record<string, string | number>> = {
